...
const docTemplate = `{
        ...
        "/reports/daily": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Tanggal laporan (Format: YYYY-MM-DD)",
                        "name": "date",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_utils.SuccessResponse-github_com_faridlan_sikon-api_internal_delivery_http_dto_ReportResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/reports/daily/generate": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Tanggal laporan (Format: YYYY-MM-DD). Jika kosong, akan menggunakan tanggal hari ini.",
                        "name": "date",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_utils.SuccessResponse-github_com_faridlan_sikon-api_internal_delivery_http_dto_MonthlyReportResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.ActivePOResponse": {
            "type": "object",
            "properties": {
                "batch_po_id": {
                    "type": "string"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.DailyReportResponse": {
            ...
            "properties": {
                "financial_summary": {
                    "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.FinancialSummaryResponse"
                },
                "order_summary": {
                    "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.OrderSummaryResponse"
                },
                "po_info": {
                    "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.POInfoResponse"
                },
                "report_date": {
                    "type": "string"
                },
                "sales_details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.SalesDetailResponse"
                    }
                }
            }
        },
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.DailySnapshotResponse": {
            "type": "object",
            "properties": {
                "sales_performance_today": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.SalesPerformanceTodayResponse"
                    }
                },
                "total_qty_today": {
                    "type": "integer"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.MonthlyDailyTrendResponse": {
            "type": "object",
            "properties": {
                "cash_in": {
                    "type": "number"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.MonthlyReportResponse": {
            "type": "object",
            "properties": {
                "daily_trends": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.MonthlyDailyTrendResponse"
                    }
                },
                "month": {
                    "type": "integer"
                ...
                "sales_performances": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.SalesPerformanceResponse"
                    }
                },
                "summary": {
                    "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.MonthlySummaryResponse"
                },
                "year": {
                    "type": "integer"
                }
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.MonthlySummaryResponse": {
            "type": "object",
            "properties": {
                "total_cash_in": {
                    "type": "number"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.OrderSummaryResponse": {
            "type": "object",
            "properties": {
                "qty_today": {
                    "type": "integer"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.POInfoResponse": {
            "type": "object",
            "properties": {
                "po_id": {
                    "type": "string"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.PastDueReceivableResponse": {
            "type": "object",
            "properties": {
                "customer_name": {
                    "type": "string"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.ReportResponse": {
            "type": "object",
            "properties": {
                "active_po_receivables": {
                    "type": "number"
                },
                "active_pos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.ActivePOResponse"
                    }
                },
                "daily_snapshot": {
                    "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.DailySnapshotResponse"
                },
                "past_due_receivables": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.PastDueReceivableResponse"
                    }
                },
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.SalesDetailResponse": {
            "type": "object",
            "properties": {
                "categories": {
                    "type": "object",
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.SalesPerformanceResponse": {
            "type": "object",
            "properties": {
                "sales_id": {
                    "type": "string"
        ...
        "github_com_faridlan_sikon-api_internal_delivery_http_dto.SalesPerformanceTodayResponse": {
            "type": "object",
            "properties": {
                "product_category": {
                    "type": "string"
        ...
        "github_com_faridlan_sikon-api_internal_utils.SuccessResponse-github_com_faridlan_sikon-api_internal_delivery_http_dto_MonthlyReportResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.MonthlyReportResponse"
                },
                "message": {
                    "type": "string"
                }
        ...
        "github_com_faridlan_sikon-api_internal_utils.SuccessResponse-github_com_faridlan_sikon-api_internal_delivery_http_dto_ReportResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_faridlan_sikon-api_internal_delivery_http_dto.ReportResponse"
                },
                "message": {
                    "type": "string"
                }
