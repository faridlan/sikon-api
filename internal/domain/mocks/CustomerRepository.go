...
func (_m *CustomerRepository) Fetch(ctx context.Context, limit int, offset int) ([]domain.Customer, int64, error) {
	...
	var r1 int64
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int) ([]domain.Customer, int64, error)); ok {
