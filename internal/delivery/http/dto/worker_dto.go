...
type WorkerCreateRequest struct {
	...
	Role       string `json:"role" validate:"required,oneof=tailor cutter finishing helper" example:"tailor"`
...
type WorkerUpdateRequest struct {
	...
	Phone      string `json:"phone" validate:"omitempty" example:"081234567890"`
	Role       string `json:"role" validate:"omitempty,oneof=tailor cutter finishing helper" example:"tailor"`
